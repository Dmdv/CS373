...
def smooth_stochastic(path, weight_data = 0.1, weight_smooth = 0.1, tolerance = 0.00001):
...
print (solution_check(smooth_stochastic(testpath1), answer1))
print (solution_check(smooth_stochastic(testpath2), answer2))
